    ...
    <footer className='flex items-center gap-3 sm:flex-row flex-col-reverse px-[25px] justify-between max-w-2xl sm:w-full w-[96%] sm:h-20 p-3 bg-stone-900 rounded-xl sm:rounded-3xl fixed bottom-[50px] left-1/2 -translate-x-1/2 shadow-[0_4px_23px_15px_rgb(0_0_0_/_0.25);] '>
      <div className=' relative w-full'>
        ...
        <input
          ...
          className='placeholder-stone-500 outline-none  text-stone-300 center text-[16.72px] center  flex w-full sm:w-[223px] h-[34px] rounded-[10px] border border-neutral-500 justify-center items-center  pl-[38px] pr-4 bg-transparent hover:bg-stone-800/50 hover:border-neutral-400 transition-all ease-in'
          placeholder='Search...'
          type='text'
        />
      </div>
