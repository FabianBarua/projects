...
export const LevelButton = ({ level }) => {
  ...
  return (
    ...
    >
      ...
      {isSelected && (
        <div className=' group  transition-all absolute top-1/2 -translate-y-1/2  -right-2 w-4 h-4  bg-neutral-900 border border-neutral-500 text-neutral-500 hover:bg-neutral-400 rounded-full flex justify-center items-center'>
          <svg
            ...
            strokeWidth={1.5}
            stroke='currentColor'
            className='w-3 h-3  group-hover:text-neutral-900'
          >
